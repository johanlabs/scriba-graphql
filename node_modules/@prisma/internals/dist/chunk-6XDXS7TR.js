...
var chunk_6XDXS7TR_exports = {};
__export(chunk_6XDXS7TR_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_6XDXS7TR_exports);
...
[Context: getDmmf]`;
    super((0, import_chunk_FSOBOKDE.addVersionDetailsToErrorMessage)(errorMessageWithContext));
  ...
  const dmmfPipeline = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        const data = import_chunk_XQMKDIJQ.prismaSchemaWasm.get_dmmf(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
