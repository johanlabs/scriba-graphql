...
var chunk_YGNELDPN_exports = {};
__export(chunk_YGNELDPN_exports, {
...
module.exports = __toCommonJS(chunk_YGNELDPN_exports);
...
var import_chunk_OQX2ALYK = require("./chunk-OQX2ALYK.js");
var import_chunk_FAJDMTA5 = require("./chunk-FAJDMTA5.js");
var import_chunk_CMORWLGD = require("./chunk-CMORWLGD.js");
var import_chunk_6BVZBBV2 = require("./chunk-6BVZBBV2.js");
var import_chunk_MQI3NLRC = require("./chunk-MQI3NLRC.js");
...
async function formatSchema({ schemas }, inputFormattingOptions) {
  if (process.env.FORCE_PANIC_PRISMA_SCHEMA) {
    handleFormatPanic(() => {
      import_chunk_MQI3NLRC.prismaSchemaWasm.debug_panic();
    });
  }
  ...
  const { formattedMultipleSchemas, lintDiagnostics } = handleFormatPanic(() => {
    ...
    const lintDiagnostics2 = (0, import_chunk_OQX2ALYK.lintSchema)({ schemas: formattedMultipleSchemas2 });
    return { formattedMultipleSchemas: formattedMultipleSchemas2, lintDiagnostics: lintDiagnostics2 };
  });
  const lintWarnings = (0, import_chunk_OQX2ALYK.getLintWarningsAsText)(lintDiagnostics);
...
function formatWasm(schema, documentFormattingParams) {
  const formattedSchema = import_chunk_MQI3NLRC.prismaSchemaWasm.format(schema, JSON.stringify(documentFormattingParams));
...
async function processSchemaResult({
  ...
  const configFromPsl = await (0, import_chunk_CMORWLGD.getConfig)({ datamodel: schemaResult.schemas });
...
async function getGenerators(options) {
  ...
  const dmmf = await (0, import_chunk_6BVZBBV2.getDMMF)({
...
You need to define \`output\` in the generator block in the schema file.`
        ...
        const datamodel = (0, import_chunk_FAJDMTA5.mergeSchemas)({ schemas: schemaContext.schemaFiles });
        const options2 = {
          datamodel,
