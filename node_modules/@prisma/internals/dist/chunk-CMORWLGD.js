...
var chunk_CMORWLGD_exports = {};
__export(chunk_CMORWLGD_exports, {
  GetConfigError: () => GetConfigError,
  getConfig: () => getConfig
});
module.exports = __toCommonJS(chunk_CMORWLGD_exports);
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        return import_chunk_MQI3NLRC.prismaSchemaWasm.get_config(params);
      },
      (e) => ({
        type: "wasm-error",
